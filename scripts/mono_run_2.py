...
def run(region, mrio_name, mrio_path, params_group, dmg_as_pct, duration, runs_dir, logger):
    ...
    sim = Simulation(params_template, mrio_path, modeltype=params_template['model_type'])
...
if __name__ == "__main__":
    ...
    scriptLogger = logging.getLogger("generic_run - {}_{}_{}_{}_{}".format(args.mrio_name, args.region, args.dmg, args.duration, args.params_group))
