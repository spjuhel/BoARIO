...
# ones.
extensions = ['sphinx.ext.napoleon', 'sphinx.ext.autodoc', 'sphinx.ext.coverage', 'sphinx.ext.intersphinx','sphinx.ext.viewcode', 'sphinx.ext.mathjax','sphinxcontrib.bibtex', 'sphinx.ext.inheritance_diagram','autoapi.sphinx','sphinx_automodapi.automodapi', 'sphinx_copybutton']
